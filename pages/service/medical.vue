<template>
    <view class="medical">
        <view class="service-title">
            <view class="service-name" :class="{ active: activeTab === item.value }" :style="{ backgroundColor: item.bgColor }" v-for="item in tabs" :key="item.value" @click="handleSwitch(item.value)">{{ item.label }}</view>
        </view>
        ...
        <section class="health-service" v-if="activeTab === 1">
            <view class="left">
                <view class="service-item">
                    ...
                    <u-image class="service-icon" src="/static/common/c7.png" width="180rpx" height="160rpx" mode="aspectFill"></u-image>
                </view>
            </view>
            <view class="right">
                <view class="service-item">
                    ...
                    <u-image class="service-icon" src="/static/common/c8.png" width="90rpx" height="100rpx" mode="WidthFix"></u-image>
                </view>
                <view class="service-item">
                    <view>
                    ...
                    <u-image class="service-icon" src="/static/common/c9.png" width="90rpx" height="100rpx" mode="WidthFix"></u-image>
                </view>
            </view>
        </section>
        <section class="health-monitor" v-if="activeTab === 2">
            <view class="monitor-item" v-for="item in healthData" :key="item.label">
                ...
                <u-image class="monitor-icon" :src="item.icon" width="80rpx" height="100rpx" mode="WidthFix"></u-image>
            </view>
        </section>
    </view>
</template>
